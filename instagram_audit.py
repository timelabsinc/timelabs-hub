...
COMPETITORS = [
    ...
    ("AG WatchStudio", "@ag_watchstudio", "High-overlap Indian mod seller. Public prices cluster around ₹17,000–₹22,000; explicitly claims assembly, testing and photography in Kanpur, free shipping, 4–6 week timelines and defect replacement. Its guide/education layer is a trust signal.", "https://agwatchstudio.in/"),
    ("SeikoMods India", "@seikomodsindia", "Newer Indian brand with named collections (Crimson Valentine, Arabic Dual Tone, Monarch Blue Roman, Ice Blue Roman) and a cleaner story-led presentation. Watch launch cadence, proof and discounting.", "https://seikomodsindia.com/"),
    ("WatchModCustom", "custom configurator", "Custom-build competitor whose observable differentiator is exclusive imagery and an online configurator. Monitor customisation UX and consultation conversion.", "https://www.watchmodcustom.com/"),
    ...
    ("Delhi Watch Co. / Coromandel / Kala / Rotoris", "Indian microbrand set", "Adjacent budget competitors surfaced by Ghadicode: Indian identity, art, heritage and mechanical storytelling compete for the same enthusiast attention even when they are not mod sellers.", "https://ghadicode.com/blog/complete-guide-indian-watch-microbrands-2026"),
